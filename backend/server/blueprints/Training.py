...
dataset_service = DatasetService.get_default_instance()
...
def save_training_measurements(activity):
    ...
    dataset_service.save_measurement(activity, count, csv_data)
...
def download_training_dataset():
    try:
        path_to_archive = dataset_service.export_tar_gz()
